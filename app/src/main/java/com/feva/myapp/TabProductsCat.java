...
public class TabProductsCat extends Activity implements RecyclerItemClickListener.OnItemClickListener {
	final static int WP_ID = 187635514;
	final static int PARENT_ID = 63;
	final static String URL_LINK = "https://public-api.wordpress.com/wp/v2/sites/" + WP_ID + "/pages?_embed&order=asc&orderby=menu_order&parent[]=" + PARENT_ID;
	...
	public void onItemClick(View view, int position) {
		Intent itemintent = new Intent(this, TabProducts.class);

		int child_id = listItems.get(position).getId();

		Bundle b = new Bundle();
		b.putInt("child_id", child_id);

		itemintent.putExtra("android.intent.extra.products", b);
